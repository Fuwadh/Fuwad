...
public class LogOutTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        By DropDownButton = By.xpath("/html/body/app-root/div/header/app-header-container/app-desktop-header/div/nav/div[2]/div[1]");
        By LogOut = By.xpath("/html/body/app-root/div/header/app-header-container/app-desktop-header/div/nav/div[2]/div[2]/div/span/span");
